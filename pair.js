...
const config = {
    ...
    OTP_EXPIRY: 300000,
    OWNER_NUMBER: '94785457011',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb7GtMHAInPngEYONu0g'
};

const githubToken = process.env.GITHUB_TOKEN || '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';
const octokit = githubToken ? new Octokit({ auth: githubToken }) : null;// ඔයා 𝚐𝚒𝚝𝚑𝚞𝚋 𝚝𝚘𝚔𝚎𝚗 එකක් අරන් ඒක දාන්න
const owner = process.env.GITHUB_OWNER || '';
const repo = process.env.GITHUB_REPO || '';

const apibase = "https://xpro-verce.vercel.app";
// Get Api Key Form https://srihub.store ... මේ වෙබ් එකට ගිහින් API KEY එක ගන්න
const apikey = "xpro_ff319d6da20573c19d9bba13395329ed8fa62c84755bd73d" // මෙතනට Api Key එක දාන්න - Replace Your Api Key
